  ...
  private readonly mockProducts: Product[] = [
    {
      ...
      calories: 850,
      ingredientsText: 'Tomato sauce, mozzarella, basil',
      allergensText: 'Gluten, milk',
    ...
    },
    {
      ...
      calories: 920,
      ingredientsText: 'Beef, cheddar, salad, tomato, bun',
      allergensText: 'Gluten, milk',
      availableFrom: '11:00:00',
      availableTo: '23:00:00',
      createdAt: new Date().toISOString(),
    ...
    },
    {
      ...
      reviews: [{ rating: 5, comment: 'Amazing', authorName: 'Leo' }],
      preparationTimeMinutes: 14,
      calories: 780,
      ingredientsText: 'Pasta, cream, bacon, parmesan',
      allergensText: 'Gluten, eggs, milk',
      availableFrom: '11:00:00',
      availableTo: '23:00:00',
      createdAt: new Date().toISOString(),
      updatedAt: new Date().toISOString(),
